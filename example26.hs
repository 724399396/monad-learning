...
{- This is an example of a helper function that can be used to put all of the lifting logic in one location and provide more informative names. this has the advantage that if the transformer stack changes in the future (say, to addErrorT) the changes to ehe existing
...
-- perform a series of computations in the combined monad, lifting computations from other monads as necessary.
main :: IO ()
